      ...
      <Row style={navBarRow}>
            ...
            <Col xs='12' lg='3' style={{display: 'flex', justifyContent: 'center'}}>
                <span style={{color: '#206A37', fontSize: 'calc(1em + 0.5vw)'}}>
                    <Link to='/adminGererBiens' style={{color: '#206A37'}} onMouseOver={changeWeight} onMouseOut={changeBackWeight}>GERER BIENS</Link>
                </span>
            </Col>
            <Col xs='12' lg='3' style={{display: 'flex', justifyContent: 'center'}}>
                <span style={{color: '#206A37', fontSize: 'calc(1em + 0.5vw)'}}>
                    <Link to='/adminGererMessages' style={{color: '#206A37'}} onMouseOver={changeWeight} onMouseOut={changeBackWeight}>GERER MESSAGES</Link>
                </span>
            </Col>
            <Col xs='12' lg='3' style={{display: 'flex', justifyContent: 'center'}}>
                <span style={{color: '#206A37', fontSize: 'calc(1em + 0.5vw)'}}>
                    <Link to='/adminGererAdmin' style={{color: '#206A37'}} onMouseOver={changeWeight} onMouseOut={changeBackWeight}>GERER ADMINS</Link>
                </span>
            </Col>
            <Col xs='12' lg='1' style={{display: 'flex', justifyContent: 'center', fontSize: '1vw'}}>
